                                            ...
                                            <li class="is-mobile-login">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="customer dropdown-menu">
                                                        ...
                                                        <li class="logout"><a href="https://site/account/login">Inicio de sesi&oacute;n</a></li>
                ...
                <div id="content" class="clearfix">
                    ...
                    <div id="breadcrumb" class="breadcrumb">
                        <div itemprop="breadcrumb" class="container">
                            <div class="row">
                                <div class="col-md-24"><a href="../index.php" class="homepage-link" title="Back to the frontpage">Inicio</a> <span>/</span> <span class="page-title">Anillos</span></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div id="collection-content">
                                    ...
                                    <div id="page-header" class="col-sm-24">
                                      <p id="page-title" class='chopsFontTitle'>Anillos</p>
                                    </div>
                                    ...
                                    <div class="collection-warper col-sm-24 clearfix">
                                        ...
                                        <div class="collection-panner"><img src="<?php echo $context ?>/site/img/collection/rings/banner_anillos.jpg" class="img-responsive" alt="" /></div>
      ...
      <a onClick='previewProducto({$registro['idProducto']})'  data-target='#quick-shop-modal' data-toggle='modal'
		...
		<li class='row-right parent-fly animMix'>
			<div class='product-content-left'>
				<a class='title-5' href='#' data-target='#quick-shop-modal'>
		 			{$registro['titulo']} 
		 		</a>
