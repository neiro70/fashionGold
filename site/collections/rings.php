...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Anillos | Fashion Gold</title>
							...
							<div itemprop="breadcrumb" class="container">
								<div class="row">
									<div class="col-md-24">
										...
										<span>/</span>
										<span class="page-title">Anillos</span>
									</div>
								</div>
							</div>
						</div>
                            ...
                            <div class="row">
                                ...
                                <div id="collection-content">
                                    ...
                                    <div class="collection-warper col-sm-24 clearfix">
                                        <div class="collection-panner" align="center"><img src="<?php echo $context ?>/site/img/collection/rings/banner_anillos.jpg" class="img-responsive" alt="" /></div>
                                    </div>
