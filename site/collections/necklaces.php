	...
	<span class="icon-bar"></span></button>
		...
		<i class="fa fa-caret-down"></i> <i
			...
			class="sub-dropdown visible-sm visible-md visible-lg"></i> </a>
                                            ...
                                            <li class="nav-item dropdown"><a href="<?php echo $context ?>/site/pages/blogs/blogs.html" class="dropdown-toggle dropdown-link" data-toggle="dropdown"> <span>Blog</span>
                ...
                <div id="content" class="clearfix">
                    ...
                    <div id="breadcrumb" class="breadcrumb">
                        <div itemprop="breadcrumb" class="container">
                            <div class="row">
                                <div class="col-md-24"><a href="<?php echo $context ?>" class="homepage-link" title="Back to the frontpage">Inicio</a> <span>/</span> <span class="page-title">Gargantillas</span></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div id="collection-content">
                                    ...
                                    <div id="page-header" class="col-sm-24">
                                      <p id="page-title" class='chopsFontTitle'>Gargantillas</p>
                                    </div>
                                    ...
                                    <div class="collection-warper col-sm-24 clearfix">
                                        ...
                                        <div class="collection-panner" align="center"><img src="<?php echo $context ?>/site/img/collection/necklances/banner_collares.jpg" class="img-responsive" alt="" /></div>
                                ...
                                <div id="quick-shop-modal" class="modal" role="dialog" aria-hidden="true" tabindex="-1" data-width="800">
                                    <div class="modal-dialog rotateInDownLeft">
                                        <div class="modal-content">
                                            <div class="modal-header"><i class="close fa fa-times btooltip" data-toggle="tooltip" data-placement="top" title="Cerrar" data-dismiss="modal" aria-hidden="true"></i>
                                            </div>
                                    ...
                                    if (key === 'items') {
                                        ...
                                        if (value.length) {
                                            ...
                                            jQuery.each(value, function(i, item) {
                                                    jQuery(
                                                        '<div class="row items-wrapper"><a class="cart-close" title="Remove" href="javascript:void(0);" onclick="Shopify.removeItem(' + item.variant_id + ')"><i class="fa fa-times"></i></a><div class="col-md-8 cart-left"><a class="cart-image" href="https://site/collections/' & #32;+&# 32; item.url & #32;+&# 32;
