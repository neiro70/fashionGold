            ...
            <div class="container">
                <div class="top-navigation">
                    ...
                    <ul class="list-inline">
                        <li class="top-logo"><a id="site-title" href="<?php echo $context?>" title="Jewelry - Shopify theme"> <img class="img-responsive"
                ...
                <div id="content" class="clearfix">
                    ...
                    <div id="breadcrumb" class="breadcrumb">
                        <div itemprop="breadcrumb" class="container">
                            <div class="row">
                                <div class="col-md-24"><a href="<?php echo $context?>" class="homepage-link" title="Back to the frontpage">Inicio</a> <span>/</span> <span class="page-title">Todos los productos</span></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div id="collection-content">
                                    ...
                                    <div id="page-header" class="col-sm-24">
                                      <p id="page-title" class='chopsFontTitle'>Todos los productos</p>
                                    </div>
...
?>
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-24 product-image">
                                                                                <iframe src="" frameborder="0" id="targetiframe" style=" height:500px; width:100%;" name="targetframe" allowtransparency="true"></iframe>
                                                                                <!-- target iframe -->
                                                                            </div>
                                                                        </div>
                                                                    </div>
        ...
        <<footer id="footer">
            <div id="footer-content">
                ...
                <script src="https://cdn.shopify.com/s/files/1/0908/7252/t/2/assets/cs.global.js?14058599523483859647" type="text/javascript">
                    < /scrtargetiframeipt>
