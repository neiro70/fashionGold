...
include("../../site/admin/mvc/util/MysqlDAO.php");
	...
	$sql="SELECT m01.idImagen,t01.txtCodigo,t01.idProducto,t01.isOferta, t01.txtTitulo,t01.dPrecioComercial,t01.dPrecioOferta,t01.txtDescripcion,c02.txtDescripcion AS estatus,c01.txtdescripcion as tipo,t01.idStatus
...
<title>Aretes FashionGold</title>
...
<div class="col-md-6 phone-shopping"><span>Ventas Mex (55) 3488 1042</span></div>
	...
	<ul id="accounts" class="list-inline">
		...
		<ul class="control-container customer-accounts list-unstyled">
			<li class="clearfix"><label for="customer_email_box"
				class="control-label">Email Address <span class="req">*</span></label>
			<input type="email" value="" name="customer[email]"
				id="customer_email_box" class="form-control" /></li>
		...
		<li class="register"><a href="https://site/account/register"
			id="customer_register_link">Crear una cuenta</a></li>
...
<ul class="list-inline">
	<li class="top-logo"><a id="site-title" href="../index.html"
		title="Jewelry - Shopify theme"> <img class="img-re/site/index.phpsponsive"
...
<div class="col-md-24"><a href="<?php echo $context?>" class="homepage-link"
	...
	class="page-title">Aretes</span></div>
</div>
</div>
</div>
...
<div class="collection-panner" align="center" ><img
	src="<?php echo $context ?>/site/img/collection/aretes/BANNER_ARETES.jpg"
...
<ul class="list-unstyled list-styled">
	...
	<li class="list-unstyled"><a href="index.php">Qui�nes Somos</a></li>
...
<div class="copyright col-md-12">&copy; 2017 <a href="#">FashionGold</a>.
