            ...
            <div class="container">
                <div class="top-navigation">
                    ...
                    <ul class="list-inline">
                        <li class="top-logo"><a id="site-title" href="../index.php" > <img class="img-re/site/index.phpsponsive"
                ...
                <div id="content" class="clearfix">
                    ...
                    <div id="breadcrumb" class="breadcrumb">
                        <div itemprop="breadcrumb" class="container">
                            <div class="row">
                                <div class="col-md-24"><a href="<?php echo $context?>" class="homepage-link" title="Back to the frontpage">Inicio</a> <span>/</span> <span class="page-title">Aretes</span></div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div id="collection-content">
                                    ...
                                    <div id="page-header" class="col-sm-24">
                                        <p id="page-title" class='chopsFontTitle'>Aretes</p>
                                    </div>
                                    ...
                                    <div class="collection-warper col-sm-24 clearfix">
                                        ...
                                        <div class="collection-panner" align="center"><img src="<?php echo $context ?>/site/img/collection/aretes/BANNER_ARETES.jpg" class="img-responsive" alt="" /></div>
