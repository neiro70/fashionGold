...
<html lang="en" class="no-js">
    ...
    <head>
        ...
        <title>Brazaletes | Fashion Gold</title>
							...
							<div itemprop="breadcrumb" class="container">
								<div class="row">
									<div class="col-md-24">
										...
										<span>/</span>
										<span class="page-title"> Brazaletes</span>
									</div>
								</div>
							</div>
						</div>
                            ...
                            <div class="row">
                                ...
                                <div id="collection-content">
                                    ...
                                    <div id="page-header" class="col-sm-24">
                                      <p id="page-title" class='chopsFontTitle'>Brazaletes</p>
                                    </div>

                                    <div class="collection-warper col-sm-24 clearfix">
                                        <div class="collection-panner" align="center"><img src="<?php echo $context ?>/site/img/collection/bracelets/banner2.jpg" class="img-responsive" alt="" /></div>
                                    </div>
                                                    ...
                                                    <?php
                                                        foreach($node as $posicion=>$registro){
                                                            ...
                                                            <ul class='row-container list-unstyled clearfix'>
                                                                <li class='row-left'>
                                                                    <a ref='#' onClick='previewProducto({$registro['idProducto']})'  data-target='#myModalFrame' data-toggle='modal'
