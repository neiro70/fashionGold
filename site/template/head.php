<?php
    ...
    echo'
        <head>
            ...
            <link rel="icon" href="'.$context.'/rings.ico">
            <link rel="canonical" href="'.$context.'" />
            <link href="'.$context.'/fonts.googleapis.com/css%3Ffamily=Carrois+Gothic.css" rel="stylesheet" type="text/css">
            <link href="'.$context.'/fonts.googleapis.com/css%3Ffamily=Lato:100,300,400,700.css" rel="stylesheet" type="text/css">
            <link href="'.$context.'/fonts.googleapis.com/css%3Ffamily=Raleway:400,600,500,700.css" rel="stylesheet" type="text/css">
            <link href="'.$context.'/fonts.googleapis.com/css%3Ffamily=Belleza.css" rel="stylesheet" type="text/css">
            <link href="'.$context.'/fonts.googleapis.com/css%3Ffamily=Quicksand:300,400,700.css" rel="stylesheet" type="text/css">
